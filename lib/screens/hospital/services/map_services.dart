...
class MapServices {
  final String key = 'AIzaSyCxqriQbYf-UMvPX2vfrvtNYzOvB8Jn_t8';
  ...
  Future<dynamic> getPlaceDetails(LatLng coords, int radius) async {
    ...
    final String url =
        'https://maps.googleapis.com/maps/api/place/nearbysearch/json?&location=$lat,$lng&radius=$radius&type=hospital&key=$key';
