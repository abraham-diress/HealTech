...
import 'package:HealTech/screens/hospital/models/auto_complete_result.dart';
import 'package:HealTech/screens/hospital/providers/search_places.dart';
import 'package:HealTech/screens/hospital/services/map_services.dart';
...
//Markers set
  ...
  final key = 'AIzaSyCxqriQbYf-UMvPX2vfrvtNYzOvB8Jn_t8';
...
//Initial map position on load
  static final CameraPosition _kGooglePlex = CameraPosition(
    target: LatLng(-1.9565656054233524, 30.100421513644793),
    zoom: 14.4746,
  );
  ...
  _setNearMarker(LatLng point, String label, List types, String status) async {
    ...
    if (types.contains('restaurants'))
      ...
      markerIcon = await getBytesFromAsset('mapicons/bars.png', 75);
