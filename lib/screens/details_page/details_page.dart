...
import '../../screens/doctor_page/models/doctor_model.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.phone, color: Colors.orangeAccent.shade700),
                SizedBox(width: 10.0),
                Text(
            ...
            Row(
              children: [
                Icon(Icons.email, color: Colors.orangeAccent.shade700),
                SizedBox(width: 10.0),
                Text(
                  doctor.doctorEmail!,
                  style: TextStyle(
