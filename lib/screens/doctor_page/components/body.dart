...
import '../components/doctor_page.dart';
...
class Body extends StatelessWidget {
  ...
  builder: (context, snapshot) {
    if (snapshot.connectionState == ConnectionState.waiting) {
      ...
      DoctorList.initializeList(); // Update the displayList based on the doctorList
      return Expanded(
                ...
                return GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(context, 
                      ...
                      doctor: DoctorList.displayList[index]
                   )),
                    );
                  },
  ...
  DoctorList.displayList[index].docotorImage ?? 'https://via.placeholder.com/150',
  errorBuilder: (context, error, stackTrace) => Image.network('https://via.placeholder.com/150'),
  height: 100, // change this value to adjust the height of the image
  width: 40, // change this value to adjust the width of the image
),
    title: Text(
